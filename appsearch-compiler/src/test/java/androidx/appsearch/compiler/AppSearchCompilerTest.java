    ...
    public void testNestedDocumentsIndexing() throws Exception {
        Compilation compilation = compile(
                "import java.util.*;\n" +
                        ...
                        "  @Document.Id private String mId;\n" +
                        "  @Document.Namespace private String mNamespace;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = true) private Collection<GiftContent> mGiftContentsCollection;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = true) private GiftContent[] mGiftContentsArray;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = true) private GiftContent mGiftContent;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = false) private Collection<GiftContent> mGiftContentsCollectionNotIndexed;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = false) private GiftContent[] mGiftContentsArrayNotIndexed;\n" +
                        "  @Document.DocumentProperty(indexNestedProperties = false) private GiftContent mGiftContentNotIndexed;\n" +
                        "}\n" +
                        "\n" +
                        "@Document\n" +
                        "class GiftContent {\n" +
                        "  @Document.Id private String mId;\n" +
                        "  @Document.Namespace private String mNamespace;\n" +
                        "  @Document.StringProperty private String[] mContentsArray;\n" +
                        "  @Document.StringProperty private String mContents;\n" +
                        "}\n");
